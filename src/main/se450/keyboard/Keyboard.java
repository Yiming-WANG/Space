...
/**
 * Keyboard class handles everything about keyboard input and the action due the keyboard input.
 * @author Yiming Wang
 *
 */
public class Keyboard implements Runnable
{
	...
	{
		int repeatspeed = ConfigurationManager.getConfigurationManager().getConfiguration().getRepeatkeyspeed();//should replace this with value from configuration.json
		if (repeatspeed > 0)
		{
			if (scheduler == null)
			{
